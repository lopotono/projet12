		...
		<div class="jumbotron jumbotron-fluid">
			<div class="container">
				<s:iterator value="listDetails">
					...
					<br>
					<ul class="list-group">
						<li class="list-group-item"><strong>Conférencière /
								Conférencier :</strong> <s:property value="conferenciere" /></li>
						<li class="list-group-item"><strong>Adresse : </strong> <s:property
								value="place" /></li>
						<li class="list-group-item"><strong>Date de
								l'activité : </strong> <s:date name="date" format="dd/MM/yyyy" /></li>
						<li class="list-group-item"><strong>Heure de
								l'activité : </strong> <s:property value="hour" /></li>
						...
						<s:if test="genre=='exposition'">
							<li class="list-group-item"><strong>Tarif sesame
									par personne : </strong>
							<s:property value="pricesesame" /> euros</li>
						</s:if>
				...
				<form method="post" action="reserver" class="form-inline">
					<div class="form-group mx-sm-3 mb-2">
						<s:textfield name="nbreparticipants" requiredLabel="true"
							placeholder=" Nombre de participants" data-toggle="tooltip"
							data-placement="left" title="Saisir le nombre de participants" />
					</div>
