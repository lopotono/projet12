...
<html>
<head>
<title>Liste des voyages plusieurs jours</title>
<meta charset="utf-8" />
	...
	<div class="container">
		...
		<div class="list-group">
			<p class="list-group-item list-group-item-action active">LISTE
				DES VOYAGES PLUSIEURS JOURS</p>

			<s:a action="corse" class="list-group-item">INFORMATIONS SUR LE VOYAGE EN CORSE DE SEPTEMBRE 2020</s:a>

			<s:iterator value="listActivityVoyagePlus">
		...
		<s:iterator value="listActivityVoyagePlus">
			<s:if test="placesdisponibles == 0">
				<ul class="list-group">
					<li class="list-group-item"><small><s:property
