...
<body>
	<div class="container">
		...
		<ul class="list-group">
			<li class="list-group-item list-group-item-action active">LISTE
				DES THEATRES</li>

			<s:iterator value="listActivityThea">
				<s:if test="placesdisponibles > 0">
					...
					<li class="list-group-item list-group-item-action"><a
						href="${detailslink}"><s:property value="title" /></a> <i class="glyphicon glyphicon-chevron-right"></i> <small>
		...
		<br>
		<div class="alert alert-info" role="alert">Pour les
			activités suivantes toutes les places sont réservées</div>
		<s:iterator value="listActivity">
			<s:if test="placesdisponibles == 0">
				<ul class="list-group">
					<li class="list-group-item"><i class="glyphicon glyphicon-ban-circle"></i> <small><s:property
								value="title" /></small></li>
				</ul>
			</s:if>
		</s:iterator>
