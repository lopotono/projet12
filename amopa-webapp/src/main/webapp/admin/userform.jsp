...
<body>
	<div class="container">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><s:a action="listUser"
			...
			<tbody>
				<s:iterator value="listUser">
					<tr>
						...
						<td><s:url action="deleteuser" var="deleteuserlink">
								<s:param name="iduser">
									<s:property value="iduser" />
								</s:param>
							</s:url><a href="${deleteuserlink}" class="btn btn-danger btn-lg center-block">SUPPRIMER</a></td>
					</tr>
				</s:iterator>
			</tbody>
		</table>
	...
	<div class="container">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><s:a action="ajout"
	...
	<div class="container">
		<form method="post" action="addUser">
			...
			<s:textfield name="user.surname" requiredLabel="true"
				placeholder="Nom de l'amopalien(ne)" />
