...
<body>
	<div class="container">
		...
		<div class="jumbotron">
			<p class="text-primary">ADRESSES MAILS</p>
			<address class="thumbnail">
				<strong>PRESIDENTE ELIANE BAYLE</strong><br>
				lucienlouisbayle@gmail.com
			</address>

			<address class="thumbnail">
				<strong>SECRETAIRE NICOLE RESTOIN</strong><br>
				nrestoin@gmail.com
			</address>

			<address class="thumbnail">
				<strong>TRESORIER CHRISTIAN TERRAGE</strong><br>
		...
		<div class="jumbotron">
			...
			<table class="table table-striped table-bordered">
				<thead class="thead-light">
					<tr>
						<th scope="col">PRESIDENCE</th>
						<th scope="col">SECRETAIRE</th>
						<th scope="col">TRESORIER</th>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						...
						<td></td>
						<td>Du 30/08/2013 au 14/09/2015 au Monsieur Cazaban</td>
					</tr>
					<tr>
						<td></td>
						<td></td>
			...
			<address class="thumbnail">Jumelage au Pays-Bas réalisé à
				...
				Général, Président national de l’AMOPA. A partir de l’an 2000, tous
				les ans un voyage a été organisé : Tunisie nord puis sud,
				Andalousie, Crête, Rhodes et Santorin, Chypre, Hollande, Vienne…</address>
		</div>

		<div class="jumbotron">
			<p class="text-primary">CREATION DU SITE</p>
			<address class="thumbnail">
				<strong>DEVELOPPEUR DU SITE FREDERIC TERRAGE</strong><br>
